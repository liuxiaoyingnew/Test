package com.huayun.autoTest.base;
/**
 * @author 
...
import com.huayun.autoTest.utils.ExcelDataProvider;
import com.huayun.autoTest.utils.LogConfiguration;
...
public class BaseParpare {
	...
	public void startTest(ITestContext context) {
		...
		try {
			//启动浏览器launchBrowser方法，主要是打开浏览器，输入测试地址，并最大化窗口
...
//	      LoginPageHelper.onSend(seleniumUtil, LoginPage.HP_TYPE_NAME,"admin_zhangyb_a");
//	      LoginPageHelper.onSend(seleniumUtil, LoginPage.HP_TYPE_PWD, "Huayun!qazxsw2");
...
//	}
	...
	public Iterator<Object[]> dataFortestMethod() throws IOException {
		...
		int lastdoindex = packagename.lastIndexOf(".");
		int dotIndexNum = className.indexOf("."); // 取得第一个.的index
		int underlineIndexNum = className.indexOf("_"); // 取得第一个_的index

		if (dotIndexNum > 0) {	
			moduleName = className.substring(lastdoindex + 1, className.lastIndexOf(".")); // 取到模块的名称
		}
